...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h2 class="page-title">{{ __('dashboard.admin_details') }}</h2>
            <a href="{{ route('dashboard.admins.edit', $admin->id) }}" class="btn btn-primary">{{ __('dashboard.edit') }} {{ __('dashboard.admins') }}</a>
        </div>
