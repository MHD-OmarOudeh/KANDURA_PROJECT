...
<head>
    ...
    <title>Edit Admin - Kandura Store</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h2 class="page-title">{{ __('dashboard.edit') }} {{ __('dashboard.admins') }}: {{ $admin->name }}</h2>
        </div>
        ...
        <div class="form-container">
            <form action="{{ route('dashboard.admins.update', $admin->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">Leave empty if you don't want to change the password</div>
                    @error('password')
                        <div class="error">{{ $message }}</div>
                    @enderror
                </div>
